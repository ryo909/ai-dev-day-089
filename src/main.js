import './style.css';
const PROFILE = {"day":"Day089","title":"Flea Shipping Thickness Gauge","display_name_ja":"フリマ発送厚みゲージ","one_sentence":"フリマ出品物の厚み・重さ・梱包材から、発送方法の候補と危ない超過を出すツール","purpose_line_ja":"フリマ出品物の厚み・重さ・梱包材から、発送方法の候補と危ない超過を出すツールです。","use_case_line_ja":"梱包する前、どの発送方法に収まりそうか見たい時に使います。","how_it_works_line_ja":"収まるレーンと危ない超過を見る。","core_action":"fit_gauge","family":"flea_market_shipping_fit","mechanic":"lane_fit","input_style":"dimension_rows","output_style":"fit_lanes","output_label":"ここを見ればOKです","audience_promise":"梱包前に送料事故を避けやすくなる。","publish_hook":"品物、たたみ方、梱包材、厚み余白を入れると、収まる発送レーンと超過しそうな箇所が見える。","engine":"brief_driven","interaction_archetype":"lane_fit","page_archetype":"thickness_gate","ui_variant":"shipping-gauge","intro_variant":"shipping_thickness_gate","interaction_model":"editable_package_rows_to_shipping_gates","primary_layout":"dimension_editor_with_thickness_gates","result_presentation_style":"shipping_lanes_and_over_limit_tags","palette_motif":"発送厚みブルー","main_cta":"梱包前で試す","input_panel_title":"品物と梱包材を足す","sample_panel_title":"フリマ発送で試す","guide_panel_title":"厚みゲージの見どころ","hero_panel_label":"通れる発送レーン","output_shape":"thickness_gate","state_model":"lane_fit_state","core_loop":"dimension_rows -> lane_fit -> fit_lanes","component_pack":"thickness_gate+fit_lanes","scaffold_id":"brief_canvas","single_shot_text_generator":false};
